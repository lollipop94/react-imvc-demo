...
var Input = function (_Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
      ...
      _this.callAction(_defineProperty({}, path, currentValue));
      ...
      _this.callAction(_defineProperty({}, path, false));
      onFocus && onFocus(event);
    }, _this.handleBlur = function (event) {
      var _this$callAction3;
      ...
      _this.callAction((_this$callAction3 = {}, _defineProperty(_this$callAction3, pathOfValidState, isValidValue), _defineProperty(_this$callAction3, pathOfWranState, !isValidValue), _this$callAction3));
      onBlur && onBlur(event);
  ...
  _createClass(Input, [{
    ...
    key: 'callAction',
    value: function callAction(actionPayload) {
